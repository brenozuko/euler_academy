...
class Quimica extends StatefulWidget {
  ...
  @override
  State<Quimica> createState() => _QuimicaState();
}
                        ...
                        child: Column(
                          children: [
                            ...
                            TextButton(
                              ...
                              child: SizedBox(
                                  width: 120,
                                  child: Text('Separação de Misturas - 23/05',
                        ...
                        child: Column(
                          children: [
                            ...
                            TextButton(
                              ...
                              child: SizedBox(
                                width: 120,
                                child: Text('Estequiometria - 24/05',
                                    textAlign: TextAlign.center,
                                    style: TextStyle(
                                        color: Color(0xffffffff),
                                        fontSize: 20,
                        ...
                        child: Column(
                          children: [
                            ...
                            TextButton(
                              ...
                              child: SizedBox(
                                  width: 120,
                                  child: Text('Eletroquímica - 18/04',
                                      textAlign: TextAlign.center,
                                      style: TextStyle(
                                          color: Color(0xffffffff),
                                          fontSize: 20,
                        ...
                        child: Column(
                          children: [
                            ...
                            TextButton(
                              ...
                              child: SizedBox(
                                width: 120,
                                child: Text('Funções inorgânicas - 02/01',
                                    textAlign: TextAlign.center,
                                    style: TextStyle(
                                        color: Color(0xffffffff),
                                        fontSize: 20,
